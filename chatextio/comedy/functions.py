...
model=load('/Users/ADRIANA/ChatExTIO/chatextio/comedy/TF-IDF_R.Log_Model.joblib')
respuestas=open_text('/Users/ADRIANA/ChatExTIO/chatextio/comedy/Respuestas.txt')
stopwords=open_text('/Users/ADRIANA/ChatExTIO/chatextio/comedy/Stop_List.txt')
text_preguntas=clean_text('/Users/ADRIANA/ChatExTIO/chatextio/comedy/Preguntas.txt')
arch_sal_chat=clean_text('/Users/ADRIANA/ChatExTIO/chatextio/comedy/Salir_Chat.txt')
    ...
    if salida != True:
        ...
        if len(str(entrada).split()) == 1:#si se ingresa una sola palabra
            if entrada[0] == "si" or entrada[0] == "sí":
                ...
                predict=model.predict(pregunta.toarray())
                aux_pos=(int(predict.item()))
            ...
            if (entrada[0] == "de acuerdo") or (entrada[0] == "por supuesto") or (entrada[0] == "muy bien") or (entrada[0] == "está bien") or (entrada[0] == "es claro") or (entrada[0] == "me comunicaré") or (entrada[0] == "que bien") or (entrada[0] == "le agradezco") or (entrada[0] == "muchas gracias") or (entrada[0] == "muy gentil") or (entrada[0] == "muy formal") or (entrada[0] == "que tal") or (c>1):
                pregunta = vectorizer_preguntas.transform([pregunta])
                predict=model.predict(pregunta.toarray())
                aux_pos=(int(predict.item()))
                respuesta = respuestas[aux_pos]
        ...
        respuesta="Hasta pronto. Vuelva y cualquier inquietud con gusto será atendida."" Para peticiones, quejas, reclamos y sugerencias por favor comunicarse a la Escuela de Idiomas. Prof. Gabriel Quiroz, teléfono (57)(4) 219 8799 o escribir al correo electrónico: examentraductorinterpreteoficial@udea.edu.co"
